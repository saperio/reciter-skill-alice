...
function sayHello() {
	return {
		text: 'Привет! Я выбираю случайно и читаю классические стихотворения. Ты всегда можешь сказать «дальше», чтобы продожить или «другое», чтобы начать новое стихотворение. Начинаем?',
		end_session: false
	};
}
